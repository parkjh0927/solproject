		...
		<div class="depth1">
			<div class="swiper-container swiper-container-initialized swiper-container-horizontal">
				<ul class="swiper-wrapper">
					...
					<li class="swiper-slide swiper-slide-next" onclick="changetab('/main/theme.do','all');"><a href="/main/theme.do">여행 정보</a></li>
					
					<li class="swiper-slide" onclick="changetab('/main/cr_main.do?type=place','mobile');">
						<a href="javascript:;">숙박 정보</a>
					...
					<li class="swiper-slide" onclick="changetab('/tgpr/tgpr_main.do','all');"><a href="/tgpr/tgpr_main.do">게시판</a></li>
					<li class="swiper-slide" onclick="changetab('/list/travelinfo.do?service=ms','mobile');">
						<a href="javascript:;">마이 페이지</a>
						<div class="depth2 smenu2">
							<ul>
								<li id="top_menu_ms" onclick="changetab('/list/travelinfo.do?service=ms','all');"><a href="/list/travelinfo.do?service=ms">아아아</a></li>
