...
<div class="main_curation_area">
				...
				<div class="cont_wrap">
					...
					<div class="tab_cont active" id="tabMenu01"><!-- 핫플 -->
						...
						<div class="area_tab"><ul class="swiper-wrapper"><li><button type="button" class="all on">전체</button></li><li><button type="button" class="">서울</button></li><li><button type="button" class="">인천</button></li><li><button type="button" class="">대전</button></li><li><button type="button" class="">대구</button></li><li><button type="button" class="">광주</button></li><li><button type="button" class="">부산</button></li><li><button type="button" class="">울산</button></li><li><button type="button" class="">경기</button></li><li><button type="button" class="">강원</button></li><li><button type="button" class="">충북</button></li><li><button type="button" class="">충남</button></li><li><button type="button" class="">경북</button></li><li><button type="button" class="">경남</button></li><li><button type="button" class="">전북</button></li><li><button type="button" class="">전남</button></li><li><button type="button" class="">제주</button></li></ul></div>
		...
		<div class="main_curation_area area">
			...
			<div class="btn_topWrap main scroll" style="display: block;"><!-- 1210 main 클래스 추가 -->
				<div class="inner">
					...
					<a href="javascript:;" class="btn_topMove2 visible1" id="movemove">위로이동</a>
				</div>
			</div>
